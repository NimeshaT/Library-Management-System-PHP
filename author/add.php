    ...
    <?php include_once("../includes/header.php")?>
        ...
        <div class="row container-fluid">
            ...
            <div class="col-md-9 container-fluid">
                <br/>
                <h1 style="color:black;font-size:20px;margin-bottom:0"><?=$L["addauthor"]?><a href="<?=PATH ?>dashboard.php" class="btn btn-info float-right" style=color:black><?=$L["dashboard"]?></a></h1>
                <hr/>
                <?php
                        if(isset($_GET["msg"])){
                                ?>
