    ...
    <body>
        ...
        <div class="row container-fluid">
            ...
            <div class="col-md-9 container-fluid">
                <br/>
                <h1 style="color:black;font-size:20px;margin-bottom:0"><?=$L["editcategories"]?><a href="<?=PATH ?>dashboard.php" class="btn btn-info float-right" style=color:black><?=$L["dashboard"]?></a></h1>
                <hr/>
                <?php
                        if(isset($_GET["msg"])){
                            ?>
                ...
                <form action="edit_action.php" method="post" class="jumbotron">
                    <label><?=$L["id"]?></label>
                    <input type="text" name="id" class="form-control" value="<?=$row["cid"]?>" readonly><br/>
